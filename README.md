...
```
ghcr.io/benwold-lgtm/device-mcp-gateway:0.3.1@sha256:a1aae77e669d57a323166e489dbee0340efdc412ff2c586ebd52c79802e90bc7
```
...
```bash
docker buildx imagetools inspect ghcr.io/benwold-lgtm/device-mcp-gateway:0.3.1
```
...
```bash
docker build -t <your-registry>/device-mcp-gateway:0.3.1 .
docker push <your-registry>/device-mcp-gateway:0.3.1
```
