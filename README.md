...
```
ghcr.io/benwold-lgtm/device-mcp-gateway:0.3.0@sha256:d1db2897...
```
...
```bash
docker build -t <your-registry>/device-mcp-gateway:0.3.0 .
docker push <your-registry>/device-mcp-gateway:0.3.0
```
